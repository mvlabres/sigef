        ...
        <div class="slds-card__header slds-grid">
            <header class="slds-media slds-media_center slds-has-flexi-truncate">
                ...
                <div class="slds-no-flex">
                    <a href="home.php?content=productView.php" class="slds-button slds-button_neutral">Novo</a>
                </div>
            </header>
        </div>
        <div class="card-body">
            <h2 id="element-with-table-label" class="slds-text-heading_medium slds-m-bottom_xx-small">Lista de produtos</h2>
            <table class="slds-table slds-table_cell-buffer slds-table_bordered"
                ...
                <thead>
                    <tr class="slds-line-height_reset">
                        ...
                        <th class="" scope="col">
                            <div class="slds-truncate">Descrição</div>
                        </th>
                        <th class="" scope="col">
                            <div class="slds-truncate">Tamanho</div>
                        </th>
                        <th class="" scope="col">
                            <div class="slds-truncate">Código de barras</div>
                        </th>
                        <th class="" scope="col">
                            <div class="slds-truncate">Família do produto</div>
                        </th>
                        <th class="" scope="col">
